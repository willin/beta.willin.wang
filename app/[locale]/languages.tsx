  ...
  return (
    <div title={t('components.language_change')} className='dropdown dropdown-end'>
      <div tabIndex={0} className='btn btn-ghost gap-1 normal-case'>
        <svg className='inline-block h-4 w-4 fill-current md:h-5 md:w-5' xmlns='http://www.w3.org/2000/svg' width='20' height='20' viewBox='0 0 512 512'>
      ...
      <div tabIndex={0} className='dropdown-content bg-base-200 text-base-content rounded-t-box rounded-b-box top-px mt-16 w-48 overflow-y-auto shadow-2xl'>
          ...
          {Object.entries(languages).map(([key, { name, flag, unicode }]) => (
            <li key={key}>
              <Link
                ...
                <img loading='lazy' width='20' height='20' alt={flag} src={`https://cdnjs.cloudflare.com/ajax/libs/twemoji/14.0.2/svg/${unicode}.svg`} />
